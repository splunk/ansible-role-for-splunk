...
- **adhoc_change_oplog_shc.yml** - Changes the oplog for your SHC to a specific number. Uses the defaults var `splunk_oplog_size` to determine whether to modify the value or not.
